...
if (printLoadingAndLoaded == true) then print("LOADING: spelunker.lua") end

--disable vims default spell checker (never seen it in the first place lol)
vim.cmd("set nospell");
...
-- this i sd sa badly tpyes dline t o see if wornking
...
vim.cmd [[
highlight SpelunkerSpellBad cterm=underline ctermfg=247 gui=underline guifg=#ff0064
highlight SpelunkerComplexOrCompoundWord cterm=underline ctermfg=NONE gui=underline guifg=NONE
]]


if (printLoadingAndLoaded == true) then print("LOADED: spelunker.lua") end
