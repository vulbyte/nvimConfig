...
local function setupPacker()
    ...
    return require('packer').startup(function(use)
        ...
        -- B
        if (printLoadingAndLoaded == true) then print("LOADING: block") end
        use("HampusHauffman/block.nvim")
        if (printLoadingAndLoaded == true) then print("LOADED: block") end
        ...
        -- W
	-- BUG: THIS ISN'T WORKING, FIX LATER
        if (printLoadingAndLoaded == true) then print("LOADING: folke/which-key.nvim") end
	...
	-- 	  },
	-- 	} 
	if (printLoadingAndLoaded == true) then print("LOADED: folke/which-key.nvim") end
